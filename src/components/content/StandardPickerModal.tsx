  ...
  return (
    <div className="fixed inset-0 z-50">
      ...
      <div className="absolute inset-0 flex items-start justify-center p-6">
        <div className="w-full max-w-3xl bg-surface rounded-lg border border-border shadow-lg overflow-hidden" role="dialog" aria-modal="true">
          ...
          <div className="p-4 space-y-3">
            {!forceSetId ? (
              ...
              <div className="text-xs text-muted">Standard Set locked: <span className="font-medium">{forceSetId}</span></div>
            )}
                ...
                <div className="divide-y">
                  {standards.map(std => (
                    <button
                      ...
                      className="w-full px-3 py-2 text-left hover:bg-surface-100"
