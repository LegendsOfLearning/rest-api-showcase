import type { AssignmentJoinTarget } from "@/types/api";
...
export const API_ENDPOINTS = {
  ...
  APPLICATION_ME: "/api/applications/me",

  // User endpoints
  USERS: "/api/users",
  USER: (id: number | string) => `/api/users/${id}`,
  USER_LOGIN_LINK: "/api/users/login_link",
  ...
  ASSIGNMENT_JOIN: (assignmentId: number, studentId: string, target: AssignmentJoinTarget = "web") => ({
